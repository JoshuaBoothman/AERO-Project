| Date | Client | Hours | Description | Invoiced | Invoice # | Date Invoiced | Amount |
|---|---|---|---|---|---|---|---|
| 2026-01-20 | AERO Project | 0.2 | Refined Admin Dashboard (Attendees, Camping UI) | No | | | |
| 2026-01-23 | AERO Project | 1.3 | MOP Compliance (API Fixes, Frontend MOP Link, Form Uploads) | No | | | |
