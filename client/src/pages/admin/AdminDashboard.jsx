                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm flex flex-col">
                    ...
                    {selectedCampground ? (
                        <div className="flex-1 flex flex-col">
                            ...
                            {/* Bar Chart Container */}
                            <div className="flex-1 flex items-end gap-2 h-48 pt-4 pb-2 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
                                {selectedCampground.daily.map((day, i) => {
                                    ...
                                    return (
                                        <div key={i} className="flex flex-col justify-end items-center group h-full relative min-w-[3rem]">
                                            {/* Tooltip */}
                                            <div className="absolute bottom-full mb-2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 pointer-events-none border border-white/10">
